        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                ...
                if (location != null || !location.equals("")){
                    ...
                    task.execute("http://10.0.2.2/charger.php", location); // 애뮬레이터
                    //task.execute("http://192.168.56.1:443/charger.php", location); // 다른 기기로 로컬호스트에 접속할 떄 주소
                }
    ...
    private void showResult(){
        ...
        try {
            ...
            for (int i=0; i<mArrayList.size(); i++) {
                ...
                map.addMarker(new MarkerOptions().position(latLng).title(place_name).snippet("도로명 주소: " + place_address));
            }
